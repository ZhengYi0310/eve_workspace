 ...
 */
#define EIGEN2_SUPPORT //VERY IMPORTANT IF YOU USE ANY KDL RELATED LIBRARY!!!!! BEFORE ANY EGIEN HEADERS!!!!!
#define EIGEN2_SUPPORT_STAGE40_FULL_EIGEN3_STRICTNESS
//#define EIGEN2_SUPPORT_STAGE10_FULL_EIGEN2_API true 
//#define EIGEN2_SUPPORT_STAGE20_RESOLVE_API_CONFLICTS true
  ...
  bool WamNode<DOF>::Demonstration(std_srvs::Empty::Request &req, std_srvs::Empty::Response &res)
{
    ...
    //ROS_INFO("The number of subscribers for /joint_states topic is: %i", wam_joint_state_pub.getNumSubscribers());
    {
        ...
        //ROS_INFO("Make sure the system is connected on the same execution cycle!");
        time.start();
    }
